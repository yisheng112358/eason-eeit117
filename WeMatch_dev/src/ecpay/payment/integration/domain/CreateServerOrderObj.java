...
public class CreateServerOrderObj {
	...
	/**
	 * MerchantID 合作廠商編號，由綠界提供
	 */
	private String MerchantID = "";

	/**
	 * MerchantTradeNo 合作廠商交易序號
	 */
	private String MerchantTradeNo = "";

	/**
	 * MerchantTradeDate 合作廠商交易時間( yyyy/MM/dd HH:mm:ss )
	 */
	private String MerchantTradeDate = "";

	/**
	 * TotalAmount 交易金額，請帶整數，不可有小數點，僅限新台幣，金額不可為0元
	 */
	private String TotalAmount = "";

	/**
	 * CurrencyCode 幣別，Apple Server做商店驗證所傳的CurrencyCode
	 */
	private String CurrencyCode = "";

	/**
	 * ItemName 商品名稱，如果商品名稱有多筆時，請以井號分隔(#)
	 */
	...
	/**
	 * TradeType 付款方式 1. In App 2. On the Web
	 */
	private String TradeType = "";

	/**
	 * PaymentToken 付款資料物件，Apple Server做商店驗證完回傳的Merchant Session物件中payment的JSON字串
	 */
