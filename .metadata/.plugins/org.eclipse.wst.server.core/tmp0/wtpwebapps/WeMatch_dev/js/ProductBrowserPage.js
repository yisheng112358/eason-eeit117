...
function addArrivalNotice(productId, productName) {
    if (confirm(`Notice you when ${productName} arrive?`)) {
        // 把productId傳到控制器和抓會員的Email
        location = `productArrival/${productId}`;
    }
}
