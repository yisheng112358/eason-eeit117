...
public class AioCheckOutPeriod {
	...
	/**
	 * MerchantID 合作特店編號(由綠界提供)
	 */
	private String MerchantID = "";

	/**
	 * MerchantTradeNo 合作特店交易編號(由合作特店提供)，該交易編號不可重複
	 */
	private String MerchantTradeNo = "";

	/**
	 * MerchantTradeDate 合作特店交易時間
	 */
	...
	/**
	 * ClientBackURL Client端返回合作特店系統的按鈕連結
	 */
	...
	/**
	 * StoreID 合作特店商店代碼，提供合作特店填入店家代碼使用
	 */
	...
	/**
	 * CustomField2 自訂名稱欄位2，提供合作廠商使用記錄用客製化使用欄位
	 */
	private String CustomField2 = "";

	/**
	 * CustomField3 自訂名稱欄位3，提供合作廠商使用記錄用客製化使用欄位
	 */
	private String CustomField3 = "";

	/**
	 * CustomField4 自訂名稱欄位4，提供合作廠商使用記錄用客製化使用欄位
	 */
	private String CustomField4 = "";

	/**
	 * BidingCard 記憶卡號，使用記憶信用卡 1:使用 0:不使用
	 */
	private String BidingCard = "";

	/**
	 * MerchantMemberID 記憶卡號識別碼，為合作特店使的會員識別碼，若記憶卡號為1時，記憶卡號識別碼為必填
	 */
...
//	}
	...
	public String toString() {
		return "AioCheckOutPeriod [MerchantID=" + MerchantID + ", MerchantTradeNo=" + MerchantTradeNo
				...
				+ IgnorePayment + ", PlatformID=" + PlatformID + ", InvoiceMark=" + InvoiceMark + ", EncryptType="
				+ EncryptType + ", PeriodAmount=" + PeriodAmount + ", PeriodType=" + PeriodType + ", Frequency="
				+ Frequency + ", ExecTimes=" + ExecTimes + ", PeriodReturnURL=" + PeriodReturnURL + ", Language="
				+ Language + ", StoreID=" + StoreID + ", CustomField1=" + CustomField1 + ", CustomField2="
				+ CustomField2 + ", CustomField3=" + CustomField3 + ", CustomField4=" + CustomField4 + ", BidingCard="
				+ BidingCard + ", MerchantMemberID=" + MerchantMemberID + "]";
	}
}
