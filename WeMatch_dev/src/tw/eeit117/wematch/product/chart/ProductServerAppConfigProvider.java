...
public class ProductServerAppConfigProvider implements ServerApplicationConfig {
	...
	public Set<ServerEndpointConfig> getEndpointConfigs(Set<Class<? extends Endpoint>> endpointClasses) {
        ...
        for (Class<?> epClass : endpointClasses) {
             if (epClass.equals(ProgrammaticEchoEnpoint.class)) {
					ServerEndpointConfig sec = ServerEndpointConfig.Builder.create(epClass, "/productServer").build();
                result.add(sec);
            }
        }
        return result;
